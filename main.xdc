...
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports { switch_error[6] }]; #IO_L11N_T1_SRCC_16 Sch=pio[08]
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { switch_error[5] }]; #IO_L6P_T0_16 Sch=pio[09]
set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { switch_error[4] }]; #IO_L7P_T1_AD6P_35 Sch=pio[10]
...
set_property -dict { PACKAGE_PIN L2    IOSTANDARD LVCMOS33 } [get_ports { switch_error[0] }]; #IO_L5N_T0_AD13N_35 Sch=pio[14]

set_property -dict { PACKAGE_PIN M1    IOSTANDARD LVCMOS33 } [get_ports { errored_message[6] }]; #IO_L9N_T1_DQS_AD7N_35 Sch=pio[17]
set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports { errored_message[5] }]; #IO_L12P_T1_MRCC_35 Sch=pio[18]
set_property -dict { PACKAGE_PIN P3    IOSTANDARD LVCMOS33 } [get_ports { errored_message[4] }]; #IO_L12N_T1_MRCC_35 Sch=pio[19]
set_property -dict { PACKAGE_PIN M2    IOSTANDARD LVCMOS33 } [get_ports { errored_message[3] }]; #IO_L9P_T1_DQS_AD7P_35 Sch=pio[20]
...
set_property -dict { PACKAGE_PIN T1    IOSTANDARD LVCMOS33 } [get_ports { correct_output[0] }]; #IO_L3P_T0_DQS_34 Sch=pio[29]
